...
DELETE FROM Livro l WHERE l.livro_id<=44;
DELETE FROM Autor a WHERE a.autor_id<=38;
...
INSERT INTO Autor(autor_id, nome, biografia, nacionalidade, data_nascimento, data_morte) VALUES
    ...
    (10, "Milan Kundera", "Escritor e ensaísta tcheco, conhecido por obras como 'A Insustentável Leveza do Ser', que explora o amor, a política e a história.", "Tcheco", "1929-04-01", null),
    ...
    (24, "Khaled Hosseini", "Escritor afegão, autor de 'O Caçador de Pipas' e 'A Cidade do Sol', que abordam os conflitos no Afeganistão e a experiência humana.", "Afegão", "1965-03-04", null),
    ...
    (29, "John Boyne", "Escritor irlandês, autor de 'O Menino do Pijama Listrado', um conto comovente ambientado durante o Holocausto.", "Irlandês", "1971-04-30", null),
...
INSERT INTO Livro(livro_id, titulo, ano, descricao, autor) VALUES
    ...
    (19, "A Odisseia", "Século VIII a.C", "A jornada épica de Ulisses para retornar a Ítaca após a guerra de Troia, enfrentando deuses e monstros.", 18), -- Homero
